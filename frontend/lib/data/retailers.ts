...
export const RETAILERS: Retailer[] = [
  ...
  { name: "ARKET", domain: "arket.com", country: "EU", status: "optimized", wordmark: "bricolage-wide",
    note_fr: "Couvert dès le jour 1", note_en: "Covered from day 1" },
  { name: "& Other Stories", domain: "stories.com", country: "EU", status: "optimized", wordmark: "serif-italic",
    note_fr: "Tailles fines volatiles", note_en: "Smaller sizes fly" },
  { name: "Weekday", domain: "weekday.com", country: "EU", status: "optimized", wordmark: "bricolage-tight",
    note_fr: "Denim restock chaud", note_en: "Denim restocks hot" },
  { name: "Monki", domain: "monki.com", country: "EU", status: "optimized", wordmark: "bricolage-tight",
    note_fr: "Petites séries", note_en: "Small drops" },
  { name: "H&M", domain: "hm.com", country: "EU", status: "optimized", wordmark: "bricolage-tight", accent: "red",
  ...
  { name: "Rouje", domain: "rouje.com", country: "FR", status: "optimized", wordmark: "italiana-thin",
  ...
  { name: "Claudie Pierlot", domain: "claudiepierlot.com", country: "FR", status: "beta", wordmark: "serif-italic",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  { name: "the kooples", domain: "thekooples.com", country: "FR", status: "beta", wordmark: "dm-thin-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  ...
  // ── LUXURY / DESIGNER ─────────────────────────────────────────────
  { name: "BALENCIAGA", domain: "balenciaga.com", country: "FR", status: "beta", wordmark: "anton-caps",
    note_fr: "Drops limités", note_en: "Limited drops" },
  { name: "PRADA", domain: "prada.com", country: "IT", status: "beta", wordmark: "serif-bold",
    note_fr: "Accessoires convoités", note_en: "Wanted accessories" },
  { name: "GUCCI", domain: "gucci.com", country: "IT", status: "beta", wordmark: "serif-bold",
    note_fr: "Vérification dataLayer", note_en: "dataLayer check" },
  ...
  // ── SNEAKERS / STREET ─────────────────────────────────────────────
  { name: "NIKE", domain: "nike.com", country: "US/EU", status: "beta", wordmark: "anton-caps",
  ...
  { name: "WHISTLES", domain: "whistles.com", country: "UK", status: "beta", wordmark: "italiana-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  ...
  { name: "Theory", domain: "theory.com", country: "US", status: "beta", wordmark: "dm-thin-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  { name: "VINCE", domain: "vince.com", country: "US", status: "beta", wordmark: "italiana-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  ...
  { name: "Filippa K", domain: "filippa-k.com", country: "SE", status: "beta", wordmark: "dm-thin-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  { name: "Samsøe Samsøe", domain: "samsoe.com", country: "DK", status: "beta", wordmark: "dm-thin-caps",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  { name: "Stine Goya", domain: "stinegoya.com", country: "DK", status: "beta", wordmark: "serif-italic",
    note_fr: "Sur la roadmap", note_en: "On the roadmap" },
  ...
  { name: "Patagonia", domain: "patagonia.com", country: "EU", status: "beta", wordmark: "anton-caps",
    note_fr: "Re-issues & Worn Wear", note_en: "Re-issues & Worn Wear" },
  { name: "Arc'teryx", domain: "arcteryx.com", country: "EU", status: "beta", wordmark: "geist-bold",
