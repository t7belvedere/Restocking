...
export const messages = {
  fr: {
    ...
    retailers: {
      ...
      list: [
        { name: "Zara", country: "EU", status: "live", note: "SPA agressif, détection variante OK" },
        { name: "COS", country: "EU", status: "live", note: "Le sweet spot du restock" },
        { name: "Aritzia", country: "EU/US", status: "live", note: "Alerte native cassée" },
        { name: "Uniqlo", country: "EU", status: "live", note: "Délai natif 24h" },
        { name: "Sézane", country: "FR", status: "live", note: "Aucune alerte officielle" },
        { name: "Mango", country: "EU", status: "live", note: "Idéal pour le scraping HTTP" },
        { name: "Arket", country: "EU", status: "live", note: "Couvert dès le jour 1" },
        { name: "ASOS", country: "UK/EU", status: "beta", note: "Variantes complexes" },
        { name: "& Other Stories", country: "EU", status: "beta", note: "En cours" },
        { name: "Massimo Dutti", country: "EU", status: "soon", note: "Mise sur la roadmap" },
        { name: "Bershka", country: "EU", status: "soon", note: "Mise sur la roadmap" },
        { name: "The Frankie Shop", country: "EU", status: "soon", note: "Sur demande" },
      ],
    },
    pricing: {
      eyebrow: "Tarifs",
  ...
  en: {
    ...
    retailers: {
      ...
      list: [
        { name: "Zara", country: "EU", status: "live", note: "Aggressive SPA, variant detection OK" },
        { name: "COS", country: "EU", status: "live", note: "The restock sweet spot" },
        { name: "Aritzia", country: "EU/US", status: "live", note: "Native alert broken" },
        { name: "Uniqlo", country: "EU", status: "live", note: "24h native delay" },
        { name: "Sézane", country: "FR", status: "live", note: "No official alert" },
        { name: "Mango", country: "EU", status: "live", note: "Perfect for HTTP scraping" },
        { name: "Arket", country: "EU", status: "live", note: "Covered from day 1" },
        { name: "ASOS", country: "UK/EU", status: "beta", note: "Complex variants" },
        { name: "& Other Stories", country: "EU", status: "beta", note: "In progress" },
        { name: "Massimo Dutti", country: "EU", status: "soon", note: "On the roadmap" },
        { name: "Bershka", country: "EU", status: "soon", note: "On the roadmap" },
        { name: "The Frankie Shop", country: "EU", status: "soon", note: "On request" },
      ],
    },
    pricing: {
      eyebrow: "Pricing",
