...
export const messages = {
  fr: {
    ...
    retailers: {
      eyebrow: "Couverture universelle",
      title: "N’importe quelle URL. On s’en occupe.",
      sub:
        "Restocking n’est pas limité à une liste. On surveille n’importe quelle boutique de mode en Europe. Les marques ci-dessous sont simplement celles que nous avons optimisées pour une précision maximale.",
      legendInStock: "Optimisé (High-Speed)",
      legendBeta: "Support universel",
      filterAll: "Toutes les marques",
      filterLive: "Optimisées",
      filterBeta: "Universelles",
      tileCta: "Surveiller ce site",
      requestTitle: "Une boutique récalcitrante ?",
      requestBody:
        "Notre bot apprend vite. Si un site ne semble pas fonctionner, dis-le nous et on l’optimise en priorité.",
      requestCta: "Signaler un site complexe",
      noResultsTitle: "Pas de filtre correspondant.",
      noResultsBody: "Mais n'oublie pas : toutes les URLs fonctionnent !",
      universalCardTitle: "Le Bot Universel",
      universalCardBody: "Colle n'importe quel lien. Notre moteur analyse la structure en temps réel pour trouver ta taille.",
    },
    pricing: {
      eyebrow: "Tarifs",
    ...
    profile: {
      ...
      changeEmailSuccess: "Email de confirmation envoyé. Vérifie ta nouvelle boîte mail.",
    ...
    watchDetail: {
      ...
      checkHistoryDesc: "Les 20 derniers checks — mise à jour automatique toutes les 20s.",
      live: "Live",
      ...
      tableSource: "Source",
      tablePrice: "Prix",
      sourceDataLayer: "Code de la page",
      sourceAddToCart: "Bouton d'achat",
      sourceVariant: "Détail de la taille",
      sourcePlaywright: "Analyse complète",
      emptyCheckTitle: "En attente du premier check…",
      emptyCheckBody: "Le worker va bientôt analyser ce produit. Les résultats apparaîtront ici automatiquement.",
      lastCheck: "Dernier check",
      paused: "En pause",
      inStock: "En stock",
      outOfStock: "Rupture",
      ...
      pausedToast: "Alerte mise en pause",
      actionFailed: "Action impossible",
      pause: "Mettre en pause",
      reactivate: "Réactiver",
      delete: "Supprimer",
      deleteTitle: "Supprimer cette alerte ?",
      deleteDesc: "Cette action est irréversible. L'historique des vérifications sera également supprimé.",
      cancel: "Annuler",
    ...
    auth: {
      ...
      notConfiguredTitle: "Auth bientôt en ligne",
      notConfiguredBody:
