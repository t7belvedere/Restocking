...
export const messages = {
  fr: {
    ...
    pricing: {
      eyebrow: "Tarifs",
      heroTitle: "Choisis ton plan.",
      heroSub: "Commence gratuitement avec 3 produits. Passe en Pro le jour où tu rates un drop qui compte.",
      planLabel: "Plan",
      ...
      plans: {
        ...
        pro: {
          ...
          priceMonthly: "7,99€",
          priceAnnual: "59€",
          unitMonthlyShort: "/ mois",
          unitAnnualShort: "/ an",
          subMonthly: "ou 59€/an (deux mois offerts)",
          subAnnual: "soit 4,90€/mois",
          cta: "Passer Pro",
        },
      },
      features: {
        items: "Produits surveillés",
        freeItems: "3 max",
        proItems: "20 max",
        frequency: "Fréquence de check",
        freeFrequency: "Toutes les 30 min",
        proFrequency: "Toutes les 5 min",
        emailNotifs: "Notifications email",
        smsNotifs: "Notifications SMS",
        optimizedStores: "Marques optimisées",
        playwright: "Fallback Playwright",
        liveDashboard: "Dashboard temps réel",
        checkHistory: "Historique des checks",
        freeHistory: "7 jours",
        proHistory: "Illimité",
        support: "Support prioritaire",
      },
      compareTitle: "Compare les plans",
      compareSub: "Tout ce qu'il te faut pour décider en 30 secondes.",
      compareFeature: "Fonctionnalité",
      testimonialsTitle: "Ceux qui sont passés en Pro",
      testimonialsSub: "Ils ne reviendraient pas en arrière.",
      testimonials: {
        "0": { quote: "Je suis passée en Pro le jour où j'ai raté un restock COS. Depuis, j'ai chopé 4 pièces que je pensais perdues.", author: "Léa, 29 ans", source: "Paris" },
        "1": { quote: "Le plan Free m'a sauvé sur Sézane. Je suis passée en Pro direct après. Les 5 minutes de check, ça change tout.", author: "Marine, 32 ans", source: "Lyon" },
        "2": { quote: "Franchement 7,99€ pour ne plus avoir à checker 20 fois par jour, c'est cadeau. J'ai lâché Distill.", author: "Thomas, 26 ans", source: "Berlin" },
      },
      faqTitle: "Questions fréquentes",
      faqSub: "Tout ce que tu veux savoir avant de passer Pro.",
      faq: {
        switchPlansQ: "Je peux changer de plan quand je veux ?",
        switchPlansA: "Oui, sans engagement. Passe en Pro quand tu veux, rétrograde en Free tout aussi facilement depuis ton dashboard.",
        cancelProQ: "Comment annuler le Pro ?",
        cancelProA: "En deux clics depuis ton compte (portail Stripe). Pas d'engagement, pas de mail à envoyer, pas de bouton caché.",
        annualOfferQ: "Vous faites une offre annuelle ?",
        annualOfferA: "Oui ! Le plan Pro annuel est à 59€/an, soit 4,90€/mois. C'est deux mois offerts par rapport au mensuel.",
        tryBeforePayQ: "Je peux tester avant de payer ?",
        tryBeforePayA: "Bien sûr. Le plan Free te donne 3 produits surveillés avec checks toutes les 30 minutes. De quoi voir si le service te plaît.",
      },
      bottomCtaEyebrow: "Prêt à ne plus rien rater ?",
      bottomCtaTitle: "Passe en Pro. Ta taille n'attendra pas.",
      bottomCtaSub: "7,99€/mois, sans engagement. Annulable en deux clics. Et si tu fais partie des 100 premiers, 3 mois offerts.",
  ...
  en: {
    ...
    pricing: {
      ...
      heroSub: "Start free with 3 items. Upgrade to Pro the day you miss a drop that matters.",
      planLabel: "Plan",
      ...
      plans: {
        ...
        pro: {
          ...
          priceMonthly: "€7.99",
          priceAnnual: "€59",
          unitMonthlyShort: "/ month",
          unitAnnualShort: "/ year",
          subMonthly: "or €59/year (two months free)",
          subAnnual: "that’s €4.90/mo",
          cta: "Go Pro",
        },
      },
      features: {
        ...
        freeFrequency: "Every 30 min",
        proFrequency: "Every 5 min",
        emailNotifs: "Email notifications",
        smsNotifs: "SMS notifications",
        optimizedStores: "Optimized stores",
        playwright: "Playwright fallback",
        liveDashboard: "Live dashboard",
        checkHistory: "Check history",
        freeHistory: "7 days",
        proHistory: "Unlimited",
        support: "Priority support",
      },
      compareTitle: "Compare plans",
      compareSub: "Everything you need to decide in 30 seconds.",
      compareFeature: "Feature",
      testimonialsTitle: "Those who went Pro",
      testimonialsSub: "They’d never go back.",
      testimonials: {
        "0": { quote: "I switched to Pro the day I missed a COS restock. Since then, I’ve scored 4 pieces I thought were gone forever.", author: "Léa, 29", source: "Paris" },
        "1": { quote: "The Free plan saved me on Sézane. I went Pro right after. The 5-minute checks change everything.", author: "Marine, 32", source: "Lyon" },
        "2": { quote: "Honestly €7.99 to stop checking 20 times a day is a gift. I dropped Distill.", author: "Thomas, 26", source: "Berlin" },
      },
      faqTitle: "Frequently asked questions",
      faqSub: "Everything you want to know before going Pro.",
      faq: {
        switchPlansQ: "Can I switch plans anytime?",
        switchPlansA: "Yes, no commitment. Upgrade to Pro whenever you want, downgrade back to Free just as easily from your dashboard.",
        cancelProQ: "How do I cancel Pro?",
        cancelProA: "Two clicks from your account (Stripe portal). No commitment, no email to send, no hidden buttons.",
        annualOfferQ: "Do you offer an annual plan?",
        annualOfferA: "Yes! The Pro annual plan is €59/year, that’s €4.90/month. Two months free compared to monthly.",
        tryBeforePayQ: "Can I try before paying?",
        tryBeforePayA: "Of course. The Free plan gives you 3 tracked items with checks every 30 minutes. Enough to see if you like the service.",
      },
      bottomCtaEyebrow: "Ready to never miss out?",
      bottomCtaTitle: "Go Pro. Your size won’t wait.",
      bottomCtaSub: "€7.99/month, no commitment. Cancel anytime in two clicks. And if you’re among the first 100, 3 months free.",
